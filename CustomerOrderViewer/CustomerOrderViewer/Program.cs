...
namespace CustomerOrderViewer
{
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                CustomerOrderDetailCommand customerOrderDetailCommand = new CustomerOrderDetailCommand(@"Data Source=DESKTOP-4M56QAV\SQLEXPRESS;Initial Catalog=CustomerOrderViewer;Integrated Security=True");
